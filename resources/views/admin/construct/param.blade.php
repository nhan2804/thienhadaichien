...
<div class="row">
	<div class="col-6">
		<h3>Thêm thông số</h3>
		<form method="post" action="{{URL::to('admin/construction/param')}}">
			@csrf
      ...
      <div class="form-group ">
        <label>% cộng thêm của thuộc tính theo hành tinh sẽ được cộng auto</label>
        <input disabled="true" class="form-control" type="" name="pm">
      </div>
			<br>
